const WebSockedUrl = "wss://echo-ws-service.herokuapp.com";
const messageInput = document.querySelector('.message');
const ButtonSend = document.querySelector('.btn-message');
const textWindow = document.querySelector('.text-window');
const ButtonGeoPosition = document.querySelector('.btn-geo-position');
const placeholder = 'Введите  текст сообщения';

// создаем объект вебсокет и описываем его поведение
let websocket = new WebSocket(WebSockedUrl); 
...
ButtonGeoPosition.addEventListener('click', () => {
